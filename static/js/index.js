...
/**geo_json_51446edfa7624e4999700360925288bb.setStyle(function(feature) {return feature.properties.style;});**/
geo_json_51446edfa7624e4999700360925288bb.bindTooltip(
    function(layer){
...
/* GeoJson 2 */
var geo_json_af5fd4f02abf42caaa66306a8ba1d7bb = new L.GeoJSON.AJAX( Flask.url_for('static', {'filename':'geojson/geo_json_af5fd4f02abf42caaa66306a8ba1d7bb.geojson' }),{style: function(feature) {return feature.properties.style;}
});
...
/* GeoJson 3 */
var geo_json_a7a99b2187454e69bfb81f6b424dc6bf = new L.GeoJSON.AJAX( Flask.url_for('static', {'filename':'geojson/geo_json_a7a99b2187454e69bfb81f6b424dc6bf.geojson'}),{style: function(feature) {return feature.properties.style;}});
geo_json_a7a99b2187454e69bfb81f6b424dc6bf.addTo(map_64b9894af4814ae08fe869ab362ce2b4 );
/*geo_json_a7a99b2187454e69bfb81f6b424dc6bf.setStyle(function(feature) {return feature.properties.style;});*/

geo_json_a7a99b2187454e69bfb81f6b424dc6bf.bindTooltip(
    function(layer){
    // Convert non-primitive to String.
    let handleObject = (feature)=>typeof(feature)=='object' ? JSON.stringify(feature) : feature;
    let fields = ['ID_MANZENT', 'Amenaza', 'Exposicion', 'Sensibilidad', 'Respuesta', 'Riesgo'];
...
/* GeoJson 4 */
var geo_json_1c01f61c237048b1a33f3863cd4c9286 = new L.GeoJSON.AJAX(  Flask.url_for('static', {'filename':'geojson/geo_json_1c01f61c237048b1a33f3863cd4c9286.geojson'}),{style: function(feature) {return feature.properties.style;}});
geo_json_1c01f61c237048b1a33f3863cd4c9286.addTo(map_64b9894af4814ae08fe869ab362ce2b4 );
/*geo_json_1c01f61c237048b1a33f3863cd4c9286.setStyle(function(feature) {return feature.properties.style;});*/


geo_json_1c01f61c237048b1a33f3863cd4c9286.bindTooltip(
    function(layer){
    // Convert non-primitive to String.
    let handleObject = (feature)=>typeof(feature)=='object' ? JSON.stringify(feature) : feature;
    let fields = ['ID_MANZENT', 'Amenaza', 'Exposicion', 'Sensibilidad', 'Respuesta', 'Riesgo'];
...
/* GeoJson 5 */
var geo_json_775ed9e500574898863ca9e695e4e33c = new L.GeoJSON.AJAX( Flask.url_for('static', {'filename':'geojson/geo_json_775ed9e500574898863ca9e695e4e33c.geojson'}),{style: function(feature) {return feature.properties.style;}});
geo_json_775ed9e500574898863ca9e695e4e33c.addTo(map_64b9894af4814ae08fe869ab362ce2b4 );
/*geo_json_775ed9e500574898863ca9e695e4e33c.setStyle(function(feature) {return feature.properties.style;});*/
    
geo_json_775ed9e500574898863ca9e695e4e33c.bindTooltip(
    function(layer){
    // Convert non-primitive to String.
    let handleObject = (feature)=>typeof(feature)=='object' ? JSON.stringify(feature) : feature;
    let fields = ['ID_MANZENT', 'Amenaza', 'Exposicion', 'Sensibilidad', 'Respuesta', 'Riesgo'];
